...
| Berkas | Deskripsi |
|---------|-----------|
| [PRAKTIKUMB6 (1).ipynb](PRAKTIKUMB6 (1).ipynb) | Notebook utama penelitian yang berisi seluruh proses implementasi model **EfficientNet-B6**, mulai dari persiapan dataset, preprocessing, pembangunan model, pelatihan, evaluasi, hingga visualisasi hasil penelitian. |
